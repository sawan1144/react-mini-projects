...
const Card = ({namee, bio, img, tech}) => {
  return (
    <div className='px-10 py-5 w-[22vw] rounded-lg bg-blue-200 flex flex-col gap-2 items-center'>
        <img src={img} className='h-20 w-20 bg-black rounded-full object-cover' />
        <div className='text-xl font-bold text-black'>{namee}</div>
        <div className='font-light text-gray-700 '>{bio}</div>
